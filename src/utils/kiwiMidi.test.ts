...
describe("kiwiMidi", () => {
  ...
  describe("parseSysex", () => {
    it("parses patch edit buffer dump command", () => {
      ...
      const result = kiwiMidi.parseSysex(mockMessage as any);
    ...
    it("parses global dump command", () => {
      ...
      const mockMessage = {
        isSystemMessage: true,
        data: [
          0xf0, 0x00, 0x21, 0x16, 0x60, 0x03, 0x00, 0x02, 0x00, 0x0f, 0x07,
          0x0a, 0x03, 0x01, 0x02, 0x03, 0x00, 0x64, 0x01, 0x00, 0x00, 0x00,
          0x07, 0x68, 0x07, 0x0f, 0x0f, 0x60, 0x5e, 0x01, 0x03, 0x01, 0x00,
    ...
    it("throws error for non-Kiwi106 sysex message", () => {
      ...
      expect(() => kiwiMidi.parseSysex(mockMessage as any)).toThrow(
